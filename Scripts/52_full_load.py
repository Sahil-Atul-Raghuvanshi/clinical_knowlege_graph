...
def main():
    ...
    try:
        ...
        script1 = import_module_from_file(os.path.join(script_dir, "1_add_patient_nodes.py"), "add_patient_nodes")
        script2 = import_module_from_file(os.path.join(script_dir, "2_patient_flow_through_the_hospital.py"), "patient_flow_through_the_hospital")
        script3 = import_module_from_file(os.path.join(script_dir, "3_add_icu_stays_label.py"), "add_icu_stays_label")
        script4 = import_module_from_file(os.path.join(script_dir, "4_add_prescription_nodes.py"), "add_prescription_nodes")
        script5 = import_module_from_file(os.path.join(script_dir, "5_add_procedure_nodes.py"), "add_procedure_nodes")
        script6 = import_module_from_file(os.path.join(script_dir, "6_add_diagnosis_nodes.py"), "add_diagnosis_nodes")
        script7 = import_module_from_file(os.path.join(script_dir, "7_add_labevent_nodes.py"), "add_labevent_nodes")
        script8 = import_module_from_file(os.path.join(script_dir, "8_add_drg_codes.py"), "add_drg_codes")
        script9 = import_module_from_file(os.path.join(script_dir, "9_add_micro_biology_events.py"), "add_micro_biology_events")
        script10 = import_module_from_file(os.path.join(script_dir, "10_add_provider_nodes.py"), "add_provider_nodes")
        script11 = import_module_from_file(os.path.join(script_dir, "11_add_assessment_nodes.py"), "add_assessment_nodes")
